...
# cursor = myset1.find({'$or':[{'gender':{'$eq':'w'}},{'age':{'$lt':19}}]},{'_id':0})
# for i in cursor:
#     print(i)

#修改
# myset1.update({'name':'Abby'},{'$unset':{'tel':''}})

# myset1.update({'name':'Jame'},{'$set':{'age':21}},multi = True)
...
#删除
# myset.remove({'King':'四爷'},multi = False)
